...
(function () {
    ...
    english.classList.add('navigation__lang-switcher-item-lang--current');
})();

currentLang.addEventListener('click', () => {
    langList.classList.toggle('navigation__lang-switcher-list--open')
});
...
function change(lang_on, lang_off1, lang_off2) {
    if (!lang_on.classList.contains('navigation__lang-switcher-item-lang--current')) {
        lang_on.classList.add('navigation__lang-switcher-item-lang--current');
        lang_off1.classList.remove('navigation__lang-switcher-item-lang--current');
        lang_off2.classList.remove('navigation__lang-switcher-item-lang--current');
    }

    if (lang_on.innerHTML === 'English') {
        currentLang.innerHTML = 'EN';
        langList.classList.remove('navigation__lang-switcher-list--open');
    }
